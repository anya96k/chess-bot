...
STOCKFISH_PATH = r"E:\Chess Bot\stockfish\stockfish-windows-x86-64-avx2.exe"
...
class ChessApp:
    ...
    def get_chatbot_advice(self, score):
        """Provide chatbot feedback based on position evaluation."""
        if score is None:
            return "It's a complex position! Think carefully."
        elif score > 300:
            return "You're in a winning position! Keep playing strong moves."
        elif score > 100:
            return "You're slightly ahead. Stay focused!"
        elif score > -100:
            return "The game is balanced. Think carefully about your next move."
        elif score > -300:
            return "You're slightly behind. Try to improve your position."
        else:
            return "You're in trouble! Look for defensive moves."
    ...
    def process_query(self, event=None):
        ...
        if query in ["help", "commands"]:
            ...
            response = "Moves so far:\n" + " ".join(move_list) if move_list else "No moves yet."
